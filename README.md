...
* Class attributes 
  - startPositionObjectY:Number
  Represents the y starting position of the object
  - startPositionObjectX:Number
  Represents the x starting position of the object
